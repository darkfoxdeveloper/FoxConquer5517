...
// zfserver v2.5517 - ServerCore - Tiger Hash Algorithm.cs
...
{
    /// <summary>
    /// The Tiger Hash Algorithm is designed using the nearly universal Merkle-Damgård paradigm. The one-way 
    /// compression function operates on 64-bit words, maintaining 3 words of state and processing 8 words of data.
    /// There are 24 rounds, using a combination of operation mixing with XOR and addition / subtraction, rotations,
    /// and substitution box lookups, and a fairly intricate key scheduling algorithm for deriving 24 round key from
    /// the 8 input words. Although fast in software, the implementation of the substitution boxes is not lightweight.
    /// </summary>
    public unsafe sealed class TigerHashAlgorithm
    {
        ...
        // Local-Scope Substitution Box Declarations:
        ...
        // Local-Scope Calculation Variable Declarations:
        ...
        /// The Tiger Hash Algorithm is designed using the nearly universal Merkle-Damgård paradigm. The one-way 
        /// compression function operates on 64-bit words, maintaining 3 words of state and processing 8 words of data.
        /// There are 24 rounds, using a combination of operation mixing with XOR and addition / substraction, rotations,
        /// and substitution box lookups, and a fairly intricate key scheduling algorithm for deriving 24 round key from
        /// the 8 input words. Although fast in software, the implementation of the substitution boxes is not lightweight.
        /// </summary>
        ...
        // Algorithm Methods:
        /// <summary> This method hashes a block of bytes using the Tiger Hash algorithm. </summary>
        /// <param name="input">The block of data being hashed.</param>
        public void Hash(byte[] input)
        {
            ...
            // Initialize / Reinitialize Round Variables:
        ...
        /// <summary> This function executes a round using the Tiger Hash Algorithm. </summary>
        /// <param name="A">Round Calculation Variable A</param>
        /// <param name="B">Round Calculation Variable B</param>
        /// <param name="C">Round Calculation Variable C</param>
        /// <param name="msg">What to ^ by.</param>
        /// <param name="mult">What to multiply by.</param>
        ...
        /// <summary> Returns the final result of the hashing algorithm. </summary>
